  ...
  List<DuaCategory> _buildFullDatabase() {
    return [
      ...
      DuaCategory(
        ...
        icon: "explore",
        subCategories: [
          SubCategory(id: "morning_adhkar", title: "Morning Adhkar", icon: "morning", duas: [
          ...
          SubCategory(id: "evening_adhkar", title: "Evening Adhkar", icon: "evening", duas: [
      ...
      DuaCategory(
        ...
        icon: "sleep",
        subCategories: [
          SubCategory(id: "before_sleeping", title: "Before Sleeping", icon: "bedtime", duas: [
      ...
      DuaCategory(
        ...
        icon: "mosque",
        subCategories: [
          SubCategory(id: "before_wudu", title: "Before Wudu", icon: "water", duas: [
            Dua(arabic: "بِسْمِ اللَّهِ", transliteration: "Bismillah", translation: "In the Name of Allah.", reference: "Abu Dawud"),
          ]),
          SubCategory(id: "after_wudu", title: "After Wudu", icon: "clean", duas: [
          ...
          SubCategory(id: "entering_mosque", title: "Entering Mosque", icon: "walk", duas: [
          ...
          SubCategory(id: "leaving_mosque", title: "Leaving Mosque", icon: "door", duas: [
          ...
          SubCategory(id: "after_salah", title: "After Salah", icon: "dua", duas: [
          ...
          SubCategory(id: "istikhara", title: "Istikhara (Guidance)", icon: "explore", duas: [
      ...
      DuaCategory(
        ...
        icon: "restaurant",
        subCategories: [
          SubCategory(id: "before_eating", title: "Before Eating", icon: "restaurant", duas: [
            Dua(arabic: "بِسْمِ اللَّهِ", transliteration: "Bismillah", translation: "In the name of Allah.", reference: "Abu Dawud"),
          ...
          SubCategory(id: "after_eating", title: "After Eating", icon: "mood", duas: [
          ...
          SubCategory(id: "drinking", title: "Drinking Water / Milk", icon: "drink", duas: [
          ...
          SubCategory(id: "wearing_clothes", title: "Wearing Clothes", icon: "clothes", duas: [
          ...
          SubCategory(id: "new_clothes", title: "Wearing New Clothes", icon: "clean", duas: [
      ...
      DuaCategory(
        ...
        icon: "home",
        subCategories: [
          SubCategory(id: "entering_home", title: "Entering Home", icon: "door", duas: [
          ...
          SubCategory(id: "leaving_home", title: "Leaving Home", icon: "walk", duas: [
          ...
          SubCategory(id: "entering_toilet", title: "Entering Toilet", icon: "wc", duas: [
          ...
          SubCategory(id: "leaving_toilet", title: "Leaving Toilet", icon: "clean", duas: [
      ...
      DuaCategory(
        ...
        icon: "person",
        subCategories: [
          SubCategory(id: "anxiety", title: "Anxiety / Stress", icon: "sad", duas: [
          ...
          SubCategory(id: "sadness", title: "Sadness", icon: "sad", duas: [
          ...
          SubCategory(id: "anger", title: "Anger", icon: "sad", duas: [
          ...
          SubCategory(id: "forgiveness", title: "Seeking Forgiveness", icon: "dua", duas: [
          ...
          SubCategory(id: "gratitude", title: "Gratitude (Shukr)", icon: "clean", duas: [
      ...
      DuaCategory(
        ...
        icon: "travel",
        subCategories: [
          SubCategory(id: "starting_journey", title: "Starting Journey", icon: "car", duas: [
          ...
          SubCategory(id: "boarding_vehicle", title: "Boarding Vehicle", icon: "travel", duas: [
            Dua(arabic: "سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقِرِنِينَ وَإِنَّا إِلَى رَبِّنَا لَمُنقَلِبُونَ", transliteration: "Subhanal-lathee sakhkhara lana hatha wama kunna lahu muqrineen, wa-inna ila rabbina lamunqaliboon", translation: "Glory be to the One Who has placed this transport at our service, and we ourselves would not have been capable of that, and to our Lord is our final destiny.", reference: "Az-Zukhruf 43:13-14"),
          ]),
          SubCategory(id: "returning_home", title: "Returning Home", icon: "home", duas: [
      ...
      DuaCategory(
        ...
        icon: "security",
        subCategories: [
          SubCategory(id: "evil_eye", title: "From Evil Eye", icon: "security", duas: [
          ...
          SubCategory(id: "shaitan", title: "From Shaitan", icon: "security", duas: [
            Dua(arabic: "أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمِ", transliteration: "A'oothu billahi minash-shaytanir-rajeem", translation: "I seek refuge in Allah from the accursed devil.", reference: "Al-Bukhari, Muslim"),
      ...
      DuaCategory(
        ...
        icon: "dua",
        subCategories: [
          SubCategory(id: "breaking_fast", title: "Breaking Fast (Iftar)", icon: "restaurant", duas: [
          ...
          SubCategory(id: "laylatul_qadr", title: "Laylatul Qadr", icon: "clean", duas: [
          ...
          SubCategory(id: "hajj_umrah", title: "During Hajj/Umrah", icon: "mosque", duas: [
      ...
      DuaCategory(
        ...
        icon: "knowledge",
        subCategories: [
          SubCategory(id: "before_studying", title: "Before Studying", icon: "book", duas: [
          ...
          SubCategory(id: "increasing_knowledge", title: "Increasing Knowledge", icon: "knowledge", duas: [
      ...
      DuaCategory(
        ...
        icon: "favorite",
        subCategories: [
          SubCategory(id: "parents", title: "For Parents", icon: "group", duas: [
          ...
          SubCategory(id: "marriage", title: "For Spouse / Marriage", icon: "favorite", duas: [
      ...
      DuaCategory(
        ...
        icon: "security",
        subCategories: [
          SubCategory(id: "debt", title: "Debt", icon: "payments", duas: [
          ...
          SubCategory(id: "difficulty", title: "General Difficulty", icon: "security", duas: [
          ...
          SubCategory(id: "oppression", title: "Against Oppression", icon: "security", duas: [
      ...
      DuaCategory(
        ...
        icon: "nature",
        subCategories: [
          SubCategory(id: "rain", title: "When It Rains", icon: "nature", duas: [
          ...
          SubCategory(id: "thunder", title: "During Thunder", icon: "flash", duas: [
          ...
          SubCategory(id: "wind", title: "During Strong Wind", icon: "nature", duas: [
          ...
          SubCategory(id: "seeing_moon", title: "Seeing New Moon", icon: "night", duas: [
      ...
      DuaCategory(
        ...
        icon: "work",
        subCategories: [
          SubCategory(id: "seeking_rizq", title: "Seeking Provision", icon: "payments", duas: [
          ...
          SubCategory(id: "before_work", title: "Before Work/Task", icon: "work", duas: [
      ...
      DuaCategory(
        ...
        icon: "group",
        subCategories: [
          SubCategory(id: "sneezing", title: "After Sneezing", icon: "health", duas: [
          ...
          SubCategory(id: "visiting", title: "Visiting Someone's Home", icon: "group", duas: [
            Dua(arabic: "اللَّهُمَّ أَطْعِمْ مَنْ أَطْعَمَنِي وَاسقِ مَنْ سَقَانِي", transliteration: "Allahumma at'im man at'amanee wasqi man saqanee", translation: "O Allah, feed the one who has fed me and quench the thirst of the one who has given me drink.", reference: "Muslim 3/1626"),
          ]),
        ],
      ),
    ];
