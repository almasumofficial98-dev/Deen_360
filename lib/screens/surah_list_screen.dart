            ...
            Expanded(
              child: _loading
                ...
                : ListView.builder(
                    ...
                    itemCount: _filteredList.length + 2, // +2 for hero and search
                    itemBuilder: (ctx, index) {
                      if (index == 0) return _buildHero();
                      if (index == 1) return _buildSearchAndCount();
                      final surah = _filteredList[index - 2];
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => widget.onNavigate('surahContent', {'number': _lastRead?['surah'] ?? 1}),
                    child: Container(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text('${surah.revelationType.toUpperCase()} • ${surah.versesCount} VERSES',
